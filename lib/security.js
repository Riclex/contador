...
// Defense-in-depth: mirrors the `From` regex in lib/schemas.js, which validates the
// webhook body via Zod first. Kept as a standalone, tested utility so phone validity
// can be asserted on code paths that don't go through the Zod middleware.
...
const SessionState = Object.freeze({
  ...
  AWAITING_REFERRAL_NAME: 'AWAITING_REFERRAL_NAME',
  AWAITING_REFERRAL_PHONE: 'AWAITING_REFERRAL_PHONE',
});
